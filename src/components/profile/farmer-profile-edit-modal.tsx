...
type FarmerProfileEditModalProps = {
  isOpen: boolean;
...
export function FarmerProfileEditModal({
  isOpen,
  profile,
  displayName,
  isSaving = false,
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="farmer-profile-edit-title"
      ...
      >
        ...
        <div className="overflow-y-auto px-6 py-5 sm:px-8 sm:py-6">
          <FarmerProfileSetupForm
            ...
            submitLabel={translate(locale, "Запази промените", "Save changes")}
            isSaving={isSaving}
            error={error}
            onSubmit={onSubmit}
            onCancel={onClose}
